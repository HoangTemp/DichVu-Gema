              ...
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="list_sp.php">Tổng sản phẩm</a></li>
                    <li class="nav-item"> <a class="nav-link" href="">Loại sản phẩm</a></li>
                  </ul>
                </div>
              </li>
              <li class="nav-item menu-items">
                <a class="nav-link" href="list_dh.php">
                  <span class="menu-icon">
